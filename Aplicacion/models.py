...
class tblUnidades(models.Model):
    ...
    Clave = models.CharField(max_length=15, null=True)
    Descripcion = models.CharField(max_length=50,null=True)
    Abreviacion = models.CharField(max_length=50,null=True)
...
class tblTecnicos(models.Model):
    ID = models.AutoField(primary_key=True)
    Tecnico = models.CharField(max_length=80,null=True)
    TecnicoEditor = models.CharField(max_length=80,null=True)
    TecnicoElimino = models.CharField(max_length=80,null=True)
    AreaRegistro = models.CharField(max_length=80,null=True)
    NombreTabla = models.CharField(max_length=80,null=True)
    IDFilaTabla = models.CharField(max_length=10, null=True)
    IDFila = models.CharField(max_length=10, null=True)
...
class tblClientes(models.Model):
    ID = models.AutoField(primary_key=True)
    Clave = models.CharField(max_length=15, null=True)
    Nombre = models.CharField(max_length=80, unique=True, null=True)
    ...
    Contacto = models.CharField(max_length=80,null=True)
    TelefonoContacto = models.CharField(max_length=80,null=True)
...
class tblContenedoresMateriaPrima(models.Model):
    ID = models.AutoField(primary_key=True)
    Clave = models.CharField(max_length=15, null=True)
    Cliente = models.CharField(max_length=80,null=True)
    IDEstatus = models.ForeignKey(tblEstatus, on_delete=models.DO_NOTHING, null=True)
    Capacidad = models.FloatField(max_length=80,null=True)
    IDCliente = models.ForeignKey(tblClientes, on_delete=models.DO_NOTHING, null=True)
    
class tblContenedoresProductos(models.Model):
    ID = models.AutoField(primary_key=True)
    Clave = models.CharField(max_length=15, null=True)
    Proveedor = models.CharField(max_length=80,null=True)
    IDEstatus = models.ForeignKey(tblEstatus, on_delete=models.DO_NOTHING, null=True)
    Capacidad = models.FloatField(max_length=80,null=True)
...
class tblAsignaCorrales(models.Model):
    ...
    IDCliente = models.ForeignKey(tblClientes, on_delete=models.DO_NOTHING, null=True)
    Fecha = models.DateTimeField(max_length=80, null=True)
...
class tblServido(models.Model):
    ...
    Fecha = models.DateTimeField(null=True)
    FechaAServir = models.DateField(null=True)
    FechaServida = models.DateTimeField(null=True)
...
class tblOtrosDatosMovMP(models.Model):
    ...
    Camion = models.CharField(max_length=80, null=True)
    Chofer = models.CharField(max_length=80, null=True)
    Placas = models.CharField(max_length=80, null=True)
...
# ----------------------------------------------------------------------------- TABLAS CRM CATALOGOS  -----------------------------------------------------------------------------
class tblCRMAcciones(models.Model):
    ID = models.AutoField(primary_key=True)
    Descripcion = models.CharField(max_length=80, null=True) 
   
class tblCRMTipoContacto(models.Model):
    ID = models.AutoField(primary_key=True)
    NomCorto = models.CharField(max_length=30, null=True)
    Descripcion = models.CharField(max_length=80, null=True)
       
class tblCRMRutas(models.Model):
    ID = models.AutoField(primary_key=True)
    NomCorto = models.CharField(max_length=30, null=True)
    Descripcion = models.CharField(max_length=80, null=True)
    
class tblCRMEstadoOportu(models.Model):
    ID = models.AutoField(primary_key=True)
    NomCorto = models.CharField(max_length=30, null=True)
    Descripcion = models.CharField(max_length=80, null=True)
...
class tblCRMListaProdInteres(models.Model):
    ID = models.AutoField(primary_key=True)
    # IDOportunidad = models.ForeignKey(tblCRMOportunidades, on_delete=models.DO_NOTHING, null=True)
    IDProducto = models.ForeignKey(tblProductos, on_delete=models.DO_NOTHING, null=True)
...
class tblCRMOportunidades(models.Model):
    ...
    IDProducto = models.ForeignKey(tblProductos, on_delete=models.DO_NOTHING, null=True)
    IDEstadoVenta = models.ForeignKey(tblCRMEstadoOportu, on_delete=models.DO_NOTHING, null=True)
    # 
    NombreProyecto = models.CharField(max_length=120,  null=True) 
    # 
    Volumen = models.CharField(max_length=20,  null=True) 
    SelectActividad = models.CharField(max_length=120,  null=True) 
    SelectTipoGanado = models.CharField(max_length=120,  null=True) 
    SelectDestino = models.CharField(max_length=120,  null=True) 
    SelectAlimentacion= models.CharField(max_length=120,  null=True) 
...
class tblCRMBitacoraInteracciones(models.Model):
    ID = models.AutoField(primary_key=True)
    # IDOportunidad = models.ForeignKey(tblCRMOportunidades, on_delete=models.DO_NOTHING, null=True)
    IDTipoAccion = models.ForeignKey(tblCRMAcciones, on_delete=models.DO_NOTHING, null=True)
    Notas = models.CharField(max_length=120,  null=True)
